...
function UseModal() {
    ...
    return (
        <div>
            <button className="homeMenuItemButton" onClick={openModal}>신환 등록하기</button>
            {/* header 부분에 텍스트를 입력한다. */}
            <Modal open={modalOpen} close={closeModal} reset={resetModal} header="신규 환자 등록">
                ...
                <form>
                    <div className="patientRegistration">
                        ...
                        <div className="inputWrapper">
                            ...
                            <div className="inputBoxEmergencyPhone">
                                <div>비상 연락처</div>
                                <input id="emergencyPhoneContent1"
                                    type="text"
                                ...
                                />
                                <span>&nbsp;-&nbsp;</span>
                                <input id="emergencyPhoneContent2"
                                    type="text"
                                ...
                                />
                                <span>&nbsp;-&nbsp;</span>
                                <input id="emergencyPhoneContent3"
                                    type="text"
                    ...
                    <div className="registerButtonWrapper">
                        <button id="withdraw" onClick={closeModal}>취소</button>
                        <div>
